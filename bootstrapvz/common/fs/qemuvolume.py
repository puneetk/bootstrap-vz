...
class QEMUVolume(LoopbackVolume):
    def _before_create(self, e):
        ...
        log_check_call([
            'qemu-img', 'create', '-f', self.qemu_format, self.image_path,
            vol_size
        ])
        ...
        if isinstance(self.partition_map, NoPartitions):
            ...
            if nbd_max_part < num_partitions:
                ...
                msg = (
                    ...
                    .format(
                        max_part=nbd_max_part, num_partitions=num_partitions))
                raise VolumeError(msg)
    ...
    def _before_attach(self, e):
        ...
        log_check_call(
            ['qemu-nbd', '--connect', self.loop_device_path, self.image_path])
