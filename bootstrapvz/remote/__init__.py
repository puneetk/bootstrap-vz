...
supported_classes = [
    'bootstrapvz.base.manifest.Manifest',
...
supported_exceptions = [
    'bootstrapvz.common.exceptions.ManifestError',
...
def deserialize(fq_classname, data):
    ...
    for key, value in data.items():
        try:
            ...
            msg = 'Unable to deserialize key `{key}\' on {class_name}'.format(
                key=key, class_name=fq_classname)
